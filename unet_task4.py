...
class UNetdropout(nn.Module):
    def __init__(self, n_class, f1, f2, f3, f4, f5, 
                activation, output_activation, dropout_rate_early=0.3, dropout_rate_late=0.5):
        super().__init__()
        ...
        self.dropout1 = nn.Dropout(p=dropout_rate_early)
        self.dropout2 = nn.Dropout(p=dropout_rate_late)
    ...
    def forward(self, x):
        ...
        xp2d = self.dropout1(xp2)

        xe31=activation_function(self.activation, self.e31_bn(self.e31(xp2d)))
        ...
        xp4d = self.dropout2(xp4)

        xe51=activation_function(self.activation, self.e51_bn(self.e51(xp4d)))
...
class UNetjoints(nn.Module):
    def __init__(self, n_class, f1, f2, f3, f4, f5, activation, output_activation, 
                 dropout_rate_early=0.3, dropout_rate_late=0.5):
        super().__init__()
        self.activation=activation
        self.output_activation=output_activation
